...
public class AplikasiEventKampus {
    ...
    public void inisialisasiData() {
        ...
        // contoh panitia
        daftarPanitia.add(new Panitia("P1", "Budi Santoso", "budi", "budi123", "Ketua"));
        daftarPanitia.add(new Panitia("P2", "Siti Aminah", "siti", "siti123", "Sekretaris"));
        // contoh event
        daftarEvent.add(new Event("E1", "Seminar AI", "20-10-2025", "Aula Utama", "Seminar teknologi AI modern", "P1"));
        daftarEvent.add(new Event("E2", "Workshop UI/UX", "25-11-2025", "Lab Multimedia", "Workshop desain antarmuka", "P2"));
        // contoh peserta
        daftarPeserta.add(new Peserta("PS1", "Andi", "andi@example.com", "E1"));
        daftarPeserta.add(new Peserta("PS2", "Rina", "rina@example.com", "E2"));
    }
